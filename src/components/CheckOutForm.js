  ...
  return (
    ...
    <CheckOutContainer>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input type="email" name="email" placeholder="nombre@dominio.com" onChange={handleChange} value={customerData.email} required />
        <label htmlFor="phone">Número de teléfono:</label>
        <input type="tel" name="phone" placeholder="Código de área sin 0" pattern="[0-9]{10}" onChange={handleChange} value={customerData.phone} required />
        ...
        <Button type="submit" color="confirm">Confirmar Compra <CheckTwoToneIcon /></Button>
      </form>
      <Link to="/cart">
